                ...
                <table class="min-w-full leading-normal">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900  whitespace-normal">23</p>
                    ...
                    <tr>
                      ...
                      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900  whitespace-normal">39</p>
                        <p class="text-gray-600  whitespace-normal"></p>
                      </td>
                      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                    ...
                    <tr>
                      ...
                      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900  whitespace-normal">40</p>
                        <p class="text-gray-600  whitespace-normal"></p>
                      </td>
                      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    ...
                    <tr>
                      ...
                      <td class="px-5 py-5 bg-white text-sm">
                        <p class="text-gray-900  whitespace-normal">6</p>
                        <p class="text-gray-600  whitespace-normal"></p>
                      </td>
                      <td class="px-5 py-5 bg-white text-sm">
